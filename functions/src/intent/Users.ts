...
export class UsersIntent {
  static listenAddReview = functions.database
    .ref("/intents/add_review/{timestamp}/{ref}")
    .onCreate(async (snapshot, context) => {
      ...
      return firestore
        ...
        .then(userDataSnapshot => {
          ...
          return firestore
            .doc(Users.getRef(data["reviewFor"]))
            .get()
            .then(reviewForDataSnapshot => {
              ...
              return firestore
                ...
                .then(freightageDataSnapshot => {
                  ...
                  if (
                    freightageData["driversRefString"].indexOf(
                      data["userRef"]
                    ) !== -1 &&
                    Users.getRef(data["reviewFor"]).indexOf(
                    ...
                    return reviewForDataSnapshot.ref
                      ...
                      .then(() => {
                        ...
                        let reviewTotalValue =
                          reviewForData.reviewTotalValue || 0;
                        reviewCount++;
                        ...
                        return reviewForDataSnapshot.ref
                          ...
                          .then(() => {
                            realtimeDatabase
                              .ref(
                                `/reviews/${userDataSnapshot.id}/${data["key"]}`
                              )
                              .remove();
                            console.log("Success");
                            return realtimeDatabase
                              .ref(
                                `/intents/add_review/${timestamp}/${ref}/response/code`
                              )
                              .ref.set(201);
                          });
                      });
                  } else if (
                    data["userRef"].indexOf(freightageData["userRef"]) !== -1 &&
                    freightageData["driversRefString"].indexOf(
                      Users.getRef(data["reviewFor"])
                    )
                  ) {
            ...
            .catch(onrejected => {
              console.log("Reject", onrejected);
              return realtimeDatabase
                .ref(`/intents/add_review/${timestamp}/${ref}/response/code`)
                .ref.set(404);
            });
        })
        .catch(onrejected => {
