                    ...
                    firestore
                        ...
                        .then(freightageDataSnapshot => {
                            ...
                            firestore
                                ...
                                .delete()
                                .then(() => {
                                    AnalyticscController.saveFreightageDeleteToAnalytics(
                        ...
                        new Promise((resolve, reject) => {
                            freightageRef
                                ...
                                .then(() => {
                                    ...
                                    AnalyticscController.saveFreightageDeclarationToAnalytics(freightageRef.id)
                            ...
                            freightageDataSnapshot.ref
                                ...
                                .then(() => {
                                    realtimeDatabase
                                        ...
                                        .ref.set({code: 200});
                                    if (!drivers.map(driver => driver.delivery).includes(false)) {
                                        AnalyticscController.saveFreightageDeliveredToAnalytics(freightageDataSnapshot.id)
                                    }
                                })
                                .catch(onrejected => {
