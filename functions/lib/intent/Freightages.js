...
FreightagesIntent.listenAddFreightageIntent = functions.database.ref('/intents/add_freightage/{timestamp}/{ref}/finished')
    ...
    return realtimeDatabase.ref(`/intents/add_freightage/${timestamp}/${ref}`).once('value', freightageDataSnapshot => {
        ...
        // }
        const promises = [];
        const freightageDoc = Object.assign({}, freightageData, { arrival_date: +freightageData.arrival_date, 
            ...
            departure_date: +freightageData.departure_date, departure_time: freightageData.departure_time, car_pool_number: (freightageData.car_pool) ? +freightageData.car_pool_number : 0, volume: +freightageData.volume, weight: +freightageData.weight, image: "", items: [], createdAt: FieldValue.serverTimestamp(), updatedAt: FieldValue.serverTimestamp(), isDeleted: false, onTransit: false, delivered: false, completed: false, idle: false, inBargain: true, pickup: false, relayCount: 0 });
